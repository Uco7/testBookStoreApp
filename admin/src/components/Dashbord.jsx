...
// //     const { admin, logout } = useAdmin(); // Destructure directly from global context
...
// //     // const adminEmail = admin?.email || admin?.email || "Admin User";
// //   return (
...
// //                    {/* <img src={admin} alt="Admin Profile"  className='admin-icon'/> */}
...
// //                                 />
// //                         </div>
// //                         <h3>Active Users: <span>{timetableLoading ? "..." : summary.activeTimetables}</span></h3>
...
// //                           </h3>
// //                         <p className='info-text'> {timetableLoading ? "..." : summary.stoppedTimetables}</p>
...
// //             {/* <div className="content-2-item-wraper"> */}
