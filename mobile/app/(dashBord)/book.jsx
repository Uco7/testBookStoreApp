...
// //     try {
// //       const data = await AsyncStorage.getItem("offline_books");
...
// //   const handleSaveOffline = async (book) => {
// //   try {
// //     if (!book?._id) return;
...
// // Replace handleSaveOffline with this
// const handleSaveOffline = async (book) => {
//   try {
//     if (!book?._id) return;
//     setSavingOfflineId(book._id);
...
//     // Update map immediately so UI reflects saved state
//     setOfflineMap((prev) => ({
//       ...prev,
//       [book._id]: {
//         saved: true,
...
// //         <ThemeText style={styles.iconText}>
// //           Save Offline
// //         </ThemeText>
// //       </>
// //     )}
...
export default function Book() {
 ...
 const openFile = async (book) => {
  ...
  //   gate(() => executeSaveOffline(book), { cooldown: AD_COOLDOWN_MS });
  // };
  ...
  // const handleSetReminder = (book) => {
  //   gate(() => executeSetReminder(book), { cooldown: AD_COOLDOWN_MS });
  // };
